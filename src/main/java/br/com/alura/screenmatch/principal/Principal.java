...
import br.com.alura.screenmatch.config.Config;
...
public class Principal {
    ...
    public void exibeMenu(){
        ...
        var json = this.consumo.obterDados(ENDERECO + nomeCodificado + API_KEY);
		...
		for (int i = 1; i <= dados.totalTemporadas() ; i++) {
			json = consumo.obterDados(ENDERECO + nomeCodificado + "&season=" + i + API_KEY);
